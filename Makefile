...
OBJECTS=AddressUtility.o GenericUtility.o ODRAPI.o UDSUtility.o MemoryAllocator.o ODRsocketUtility.o FilePortMapper.o get_hw_addrs.o BroadcastMap.o ODRutility.o ODRRoutingTable.o ODRDataPacketManager.o FrameSendRecvUtility.o FrameBufferUtility.o ODRRREQManager.o ODRRREPManager.o
